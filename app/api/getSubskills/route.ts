    ...
    //   temperature: 0.3,
      messages: [
        ...
        // },
        {
          ...
          You have to go through each skill thoroughly and understand each skill. Later you will be provided an assignment description, you have to check the presence or dominance of each skill in the assignment description and return the names of all the skills along with a "presence_score" for each skill and finally a detailed explanation of how the skills which were chosen to be present in the assignment are showcased in the assignment description. The "presence_score" that was mentioned previously is a confidence score out of 100 given to each skill which signifies how strongly that skill is present in the assignment description. The response should strictly contain two fields that is \"skills\" and \"explanation\" where \"skills\" field should be a comma separated series of the skill name's along with the "presence_score" of the skills that are present in the assignment and \"explanation\" explaining the selected skills, their presence and how they are showcased in the description. The template of response is provided in the end of the prompt for reference. The response should not contain any explanation or any other random skill name that is not present in the array of provided skills.
          ...
          \"explanation\": detailed explanation of how the chosen dominant skills in the \"skills\" are showcased in the assignment description
          `,
        },
        // {
        //     role: "user",
        ...
        },
        {
            ...
            \"explanation\": ${reqSkill == "CriticalThinking"? "the student properly understands the problem and context of real-time chat applications. He also exhibit a strong goal and works towards achieving it by building the application": reqSkill == "Communication"? "": reqSkill == "Creativity"? "Tinkering skill is exhibited in the assignment as the student is playing with new technologies. By tackeling a new problem of realtime chat application he/she also exhibit risk taking and creativity. Solving a new and challenging problem also requires the skills of non-linear thinking and also brings originality to the assignment": reqSkill == "Cognitive"? "the assignment focusses on building a new application with less to no past reference so it strongly exhibits abstract thinking and high literacy": reqSkill == "Collaboration"? "": ""}`
        },
        // {
        //     role: "user",
